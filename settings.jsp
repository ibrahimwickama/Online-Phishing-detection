...
<div style="position: absolute; width: 62px; height: 42px; z-index: 5; left: 717px; top: 2px" id="layer15">
    <div align=center style="position: absolute; width: 242px; height: 30px; z-index: 1; left: -707px; top: 358px"
         id="layer16">
        <font color=#CC0000>
            <b><%
...
<form method="POST">
    ...
    <div style="position: absolute; width: 249px; height: 67px; z-index: 1; left: 2px; top: 247px" id="layer1">
        ...
        <input type="text" name="t1" size="20" style="border-style: solid; border-width: 1px"></font>
        <p>
        ...
        <p align="center">
            <input type=button name=b value=Save
                   style="border:1px solid #800000; width: 87px; height: 24px; font-family: Times New Roman; font-weight: bold; font-size: 14pt; color: #800000; background-image: url('image/back.GIF')"
                   onclick="hai()"></p></div>
    <div align="center">
        ...
        <div style="position: absolute; width: 100px; height: 100px; z-index: 4; left: 100px; top: 92px" id="layer7">
            <div style="position: absolute; width: 246px; height: 33px; z-index: 2; left: 335px; top: 68px"
                 id="layer10">
            ...
            <div style="position: absolute; width: 100px; height: 19px; z-index: 1; left: -1px; top: 33px" id="layer8">
                <b><font face="French Script MT" color="#00FFFF" size="5">
                    <marquee width="73">Global Mail</marquee>
                </font></b></div>
            <p>&nbsp;</div>
        ...
        <p align="center"><b>
            <font color="#008000" size="4">NO</font></b></p>
        ...
        <% Vector data = m.getTable(application.getInitParameter("server")); %>
        <% for (int i = 0; i < data.size(); i++) { %>
        <% tf = (Appn.TabForm) data.get(i); %>
        <tr>
            <td width="100">
                <font size="4" color="#D96C00"><%=tf.no%>
                </font></td>
            <td width="239">
